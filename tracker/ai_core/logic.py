...
def _run_llm_semantic_analysis(
    ...
    try:
        ...
        prompt = (
            ...
            "Identify exactly 2 KEY CONCEPTUAL MISTAKES the student made.\n"
            "For each mistake:\n"
            "1. Explain WHAT was wrong (the specific misconception or error)\n"
            "2. Explain WHY this is a common error (the underlying reason students make this mistake)\n"
            "Make the explanations detailed, specific, and actionable.\n"
            "Return ONLY valid JSON using this schema:\n"
            "{\n"
            "  \"conceptual_patterns\": [\n"
            "    \"MISTAKE 1 - WHAT: [specific misconception]. WHY: [underlying reason why students commonly make this error]. EVIDENCE: [which questions show this pattern].\",\n"
            "    \"MISTAKE 2 - WHAT: [specific misconception]. WHY: [underlying reason why students commonly make this error]. EVIDENCE: [which questions show this pattern].\"\n"
            "  ],\n"
            "  \"behavior_patterns\": [\"1-3 behavior observations tied to evidence\"],\n"
            "  \"improvement_plan\": [\"2-3 specific actionable steps to correct these mistakes\"]\n"
            "}\n"
            "CRITICAL: Return EXACTLY 2 items in conceptual_patterns array, no more, no less.\n"
