...
from .views import (
    ...
    ParsePastedTeacherQuestionsView,
    UploadTeacherQuestionsCSVView,
...
urlpatterns = [
    ...
    path('upcoming-tests/<int:pk>/parse-pasted-questions/', ParsePastedTeacherQuestionsView.as_view()),
    path('upcoming-tests/<int:pk>/upload-csv-questions/', UploadTeacherQuestionsCSVView.as_view()),
    path('upcoming-tests/<int:pk>/upload-questions-csv/', UploadTeacherQuestionsCSVView.as_view()),
